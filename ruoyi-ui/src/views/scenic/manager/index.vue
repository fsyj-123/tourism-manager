<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="景区最大容客量" prop="maxCapacity">
        <el-input
          v-model="queryParams.maxCapacity"
          placeholder="请输入景区最大容客量"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="景区停车位数量" prop="parkingLots">
        <el-input
          v-model="queryParams.parkingLots"
          placeholder="请输入景区停车位数量"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="景区位置" prop="scenicSite">
        <el-input
          v-model="queryParams.scenicSite"
          placeholder="请输入景区位置"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="景区状态  0-开放  -1关闭" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择景区状态  0-开放  -1关闭" clearable>
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['scenic:manager:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['scenic:manager:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['scenic:manager:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="managerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="景区位置" align="center" prop="scenicSite" />
      <el-table-column label="景区状态  0-开放  -1关闭" align="center" prop="status">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="景区最大容客量" prop="maxCapacity">
          <el-input v-model="form.maxCapacity" placeholder="请输入景区最大容客量" />
        </el-form-item>
        <el-form-item label="景区停车位数量" prop="parkingLots">
          <el-input v-model="form.parkingLots" placeholder="请输入景区停车位数量" />
        </el-form-item>
        <el-form-item label="景区位置" prop="scenicSite">
          <el-input v-model="form.scenicSite" placeholder="请输入景区位置" />
        </el-form-item>
        <el-form-item label="景区状态  0-开放  -1关闭" prop="status">
...
<script>
import { listManager, getManager, delManager, addManager, updateManager } from "@/api/scenic/manager";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('scenic/manager/export', {
        ...this.queryParams
