<template>
    <div>
        <!-- 展示信息 -->
        <el-form :model="tourGuideInfo" v-if="!editMode" label-width="100px" style="margin: 30px 50px;">
            ...
            <el-button type="primary" @click="editMode = true" style="margin-left: 100px;">编辑</el-button>
        </el-form>
        ...
        <el-dialog title="编辑信息" :visible.sync="editMode" width="50%">
            <el-form :model="tourGuideInfo" ref="editForm" label-width="100px">
                ...
                <el-form-item label="有效日期">
                    <el-date-picker v-model="tourGuideInfo.licenseStartTime" type="date" value-format="yyyy-MM-dd"
                        placeholder="开始日期"></el-date-picker>
                    <span> 至 </span>
                    <el-date-picker v-model="tourGuideInfo.licenseEndTime" type="date" value-format="yyyy-MM-dd"
