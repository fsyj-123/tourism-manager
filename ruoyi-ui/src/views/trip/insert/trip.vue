<template>
  <div>
    ...
    <div v-if="active===0">
      <!-- 团队名称文本框 -->
      <el-form :model="formData" ref="form" style="margin: 32px;">
        <el-form-item label="团队名称">
          <el-input v-model="formData.teamName" placeholder="请输入团队名称" style="width: 20%;"></el-input>
        </el-form-item>
        <!-- 开始时间选择框 -->
      ...
      <!-- 行程表格 -->
      <el-table :data="scheduleData" style="width: 80%;margin: 32px;">
    ...
    <div v-if="active===1">
      <div>
        ...
        <!-- 团队成员表格 -->
        <el-table :data="teamData.members" style="width: 80%;margin: 32px;">
        ...
        <el-button type="primary" @click="addMemberDialogVisible=true" style="margin: 32px;">添加成员</el-button>
        <!-- 新增团队成员的 Dialog -->
    ...
    <el-button style="margin-top: 12px; margin-left: 32px;" @click="next">{{nextName}}</el-button>
  </div>
</template>
