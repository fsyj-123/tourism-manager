<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="诚信状况得分" prop="score">
        <el-input
          v-model="queryParams.score"
          placeholder="请输入诚信状况得分"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['travel_agency:manager:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['travel_agency:manager:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['travel_agency:manager:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['travel_agency:manager:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="managerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="诚信状况得分" align="center" prop="score" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="诚信状况得分" prop="score">
          <el-input v-model="form.score" placeholder="请输入诚信状况得分" />
        </el-form-item>
        <el-form-item label="状态" prop="status">
...
<script>
import { listManager, getManager, delManager, addManager, updateManager } from "@/api/travel_agency/manager";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除旅行社基础信息编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('travel_agency/manager/export', {
        ...this.queryParams
